...
#define HOTEND_OFFSET_X {0.0, 49.600} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, -2.00}  // (in mm) for each extruder, offset of the hotend on the Y axis
